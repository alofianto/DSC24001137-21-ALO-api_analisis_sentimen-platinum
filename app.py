...
from models.neural_network import A
...
@app.route('/neural-network-text-processing', methods=['POST'])
...
@swag_from("docs/nn_file_processing.yml", methods=['POST'])
@app.route('/neural-network-file-processing', methods=['POST'])
...
@swag_from("docs/lstm_file_processing.yml", methods=['POST'])
